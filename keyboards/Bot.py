...
class My_Telegram_Bot:
    ...
    async def Check_room(self, message, seseeons):
        ...
        elif seseeons["room"] == "Чорна" and day < 10:
            await bot.send_message(message.from_user.id, "До чорної кімнати можна записатися лише з 10 числа. Так що скасуй раєстрацію і спробуй ще раз")
            return False
