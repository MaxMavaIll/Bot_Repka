...
Sum_for_one_and_blue = 80
Sum_for_one_and_red = 70
Sum_for_group_and_blue = 100
Sum_for_group_and_red = 80
Night_red = 500
Night_blue = 600
...
async def Start(message : types.Message):
    ...
    await message.answer("Всім привіт у нас з'явилася нова Чорна Кімната. Вже зараз можна почати реєстрування до Чорної кімнати, але з 10 числа")
